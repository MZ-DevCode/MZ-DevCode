...
- Working across both low-level and high-level development: **Go** and **C**.
- Interested in computer networks, operating systems architecture (**Linux**, **BSD**), and cybersecurity.
- I use **Arch Linux** and **FreeBSD**.
